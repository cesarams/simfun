...
{block name='page_title'}
	{l s='Simulador de crédito' d='Modules.simfun'}</h1>
{/block}
...
<div id="step1" class="col-md-12 simfun">
  <div class="row">
    ...
    <p>{l s='Ingresa el valor de la compra que deseas realizar y el plazo a cual deseas diferirla' d='Modules.simfun'}</p>
    <form data-action="{$action}" method="post" id="formsimulate" enctype="multipart/form-data">
      ...
      <div class="submit">
        <button type="submit" id="calculate" name="calculate" class="button btn btn-default button-medium"><span>{l s='Calcular' d='Modules.simfun'}<i class="icon-chevron-right right"></i></span></button>
      </div>
    </form>
  </div>
  <div id="step2" class="row">
    ...
    <button type="button" id="request" name="request" class="button btn btn-default button-medium"> <span>{l s='Solicitar Crédito' d='Modules.simfun'}<i class="icon-chevron-right right"></i></span> </button>
  </div>
</div>
<div id="step3" class="row">
  <form action="" method="post" name="get" id="get" enctype="multipart/form-data">
    ...
    {/if}
    <div class="form-group col-md-12">
      <button type="button" id="register" name="register" class="button btn btn-default button-medium"> <span>{l s='Solicitar Crédito' d='Modules.simfun'}<i class="icon-chevron-right right"></i></span> </button>
    </div>
  </form>
</div>
{/block}